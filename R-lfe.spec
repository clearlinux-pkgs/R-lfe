...
Version  : 3.1.0
Release  : 69
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/lfe_3.1.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/lfe_3.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731644557
...
/usr/lib64/R/library/lfe/LICENSE
